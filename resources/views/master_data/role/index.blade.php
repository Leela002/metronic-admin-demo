    ...
    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
        ...
        <div class="card-header cursor-pointer">
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">{{ __('Roles') }}</h3>
            </div>
        </div>
        ...
        <div class="card m-5 p-4">
            <div class="row mb-5 mb-xl-10">
                <div class="d-flex align-items-center position-relative my-1 w-100">
                    ...
                    <a href="{{ theme()->getPageUrl('create_role') }}" class="btn btn-primary ms-auto"
                        style="padding: calc(0.775rem + 1px) calc(1.5rem + 1px) !important;">{{ __('Add Role') }}</a>
                            ...
                            <tr>
                                ...
                                <td class="p-0 pb-3 w-50px text-center">
                                    <div class="d-flex justify-content-around">
                                        <a href="{{ route('edit_role', $identity->id) }}"
                                            class="btn btn-light-primary font-weight-bold mr-2"> View </a>

                                        <form action="{{ route('role.destroy', $identity->id) }}" method="POST"
