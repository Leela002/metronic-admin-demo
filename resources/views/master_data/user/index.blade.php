...
<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
    ...
    <div class="card-header cursor-pointer">
        ...
        <!--begin::Action-->
        <a href="{{ theme()->getPageUrl('create_user') }}" class="btn btn-primary align-self-center"style="padding: calc(0.775rem + 1px) calc(1.5rem + 1px) !important;">{{ __('Add User') }}</a>
        <!--end::Action -->
    </div>
    <!--begin::Card-->
    <div class="card">
        ...
        <div class="table-responsive signing_fees">
                <table class="table dataTable " id="data-table">
                    ...
                    @foreach($users as $user)
                                ...
                                <a href="{{ route('edit_role', $user->id) }}" class="btn btn-light-primary font-weight-bold mr-2"> View </a>
