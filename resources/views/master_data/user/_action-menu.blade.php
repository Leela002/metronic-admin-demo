...
<td class="text-end">
    <div class="text-center">        
        <a href="{{ url('edit_user', $model->id) }}" class="btn btn-light-primary font-weight-bold">
        <img alt="Logo"src="{{ asset(theme()->getMediaUrlPath() . 'logos/edit.png') }}"class="h-15px app-sidebar-logo-default mr-2" />
        </a>
        <button data-destroy="{{ url('user/destroy', $model->id) }}" class="btn btn-light-danger font-weight-bold">
