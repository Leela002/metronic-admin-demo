   ...
   .btn-light-primary{
    ...
    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
        ...
        <div class="card-header cursor-pointer">
            ...
            <!--begin::Action-->
            <a href="{{ route('profile.create') }}" class="btn btn-primary align-self-center" style="padding: calc(0.775rem + 1px) calc(1.5rem + 1px) !important;">{{ __('Add Profile Details') }}</a>
            <!--end::Action -->
        </div>
                ...
                <table class="table dataTable " id="data-table">
                    ...
                    <thead>
                        ...
                        <th class="min-w-175px text-center">Id</th>
                            <th class="min-w-175px text-center">Employee&nbsp;Id</th>
                            <th class="min-w-175px text-center">Full&nbsp;Name</th>
                            <th class="min-w-175px text-center">Father&nbsp;Name</th>
                            <th class="min-w-175px text-center">Mother&nbsp;Name</th>
                            <th class="min-w-175px text-center">Current&nbsp;Address</th>
                            <th class="min-w-175px text-center">Permanent&nbsp;Address</th>
                    ...
                    @foreach($identities as $identity)
                                        ...
                                        <td class="p-0 pb-3 w-50px text-center">{{$identity->id}}</td>
                                            <td class="p-0 pb-3 w-50px text-center">{{$identity->emp_id }}</td>
                                            <td class="p-0 pb-3 w-50px text-center">{{$identity->name }}</td>
                                            <td class="p-0 pb-3 w-50px text-center">{{$identity->father_name}}</td>
                                            <td class="p-0 pb-3 w-50px text-center">{{$identity->mother_name}}</td>
                                            <td class="p-0 pb-3 w-50px text-center">{{$identity->cur_address }}</td>
                                            <td class="p-0 pb-3 w-50px text-center">{{$identity->per_address}}</td>
                                ...
                                <div class="d-flex justify-content-around">
                                    <a href="{{ route('profile.edit', $identity->id) }}" class="btn btn-light-primary font-weight-bold mr-2">
                                        View
                                    </a>
